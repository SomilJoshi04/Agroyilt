...
const { getProfile, updateProfile, updateAvailability, updateLocation } = require('../../controllers/workerControllers/workerProfileController');
...
router.put('/profile/availability', authenticate, isWorker, updateAvailability);
